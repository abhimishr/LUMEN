...
ov_cost_tr_cities(t, iso,commodity, "marginal")             = vm_cost_tr_cities.m(iso,commodity);
ov_cost_tr_ports(t, iso,commodity, "marginal")              = vm_cost_tr_ports.m(iso,commodity);
ov_cost_trade_iso(t, iso,commodity, "marginal")             = vm_cost_trade_iso.m(iso,commodity);
...
ov_cost_tr_cities(t, iso,commodity, "level")                = vm_cost_tr_cities.l(iso,commodity);
ov_cost_tr_ports(t, iso,commodity, "level")                 = vm_cost_tr_ports.l(iso,commodity);
ov_cost_trade_iso(t, iso,commodity, "level")                = vm_cost_trade_iso.l(iso,commodity);
...
ov_cost_tr_cities(t, iso,commodity, "upper")                = vm_cost_tr_cities.up(iso,commodity);
ov_cost_tr_ports(t, iso,commodity, "upper")                 = vm_cost_tr_ports.up(iso,commodity);
ov_cost_trade_iso(t, iso,commodity, "upper")                = vm_cost_trade_iso.up(iso,commodity);
...
ov_cost_tr_cities(t, iso,commodity, "lower")                = vm_cost_tr_cities.lo(iso,commodity);
ov_cost_tr_ports(t, iso,commodity, "lower")                 = vm_cost_tr_ports.lo(iso,commodity);
ov_cost_trade_iso(t, iso,commodity, "lower")                = vm_cost_trade_iso.lo(iso,commodity);
