...
*########### Begin R section ###########
ov_landexpansion(t, fpu, land_class_agg, "marginal")                = v11_landexpansion.m(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "marginal")                = v11_landreduction.m(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "marginal")                         = vm_cost_land_transition.m(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "marginal")            = v11_lu_transitions.m(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "marginal")      = v11_landreduction_cost.m(fpu, land_avl_conversion);
...
oq11_cost_reduction(t, fpu, land_avl_conversion, "marginal")        = q11_cost_reduction.m(fpu, land_avl_conversion);
ov_landexpansion(t, fpu, land_class_agg, "level")                   = v11_landexpansion.l(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "level")                   = v11_landreduction.l(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "level")                            = vm_cost_land_transition.l(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "level")               = v11_lu_transitions.l(fpu, land_from,land_to);
ov11_balance_positive(t, fpu, "level")                              = v11_balance_positive.l(fpu);
ov11_balance_negative(t, fpu, "level")                              = v11_balance_negative.l(fpu);
ov_landreduction_cost(t, fpu, land_avl_conversion, "level")         = v11_landreduction_cost.l(fpu, land_avl_conversion);
...
oq11_cost_reduction(t, fpu, land_avl_conversion, "level")           = q11_cost_reduction.l(fpu, land_avl_conversion);
ov_landexpansion(t, fpu, land_class_agg, "upper")                   = v11_landexpansion.up(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "upper")                   = v11_landreduction.up(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "upper")                            = vm_cost_land_transition.up(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "upper")               = v11_lu_transitions.up(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "upper")         = v11_landreduction_cost.up(fpu, land_avl_conversion);
...
oq11_cost_reduction(t, fpu, land_avl_conversion, "upper")           = q11_cost_reduction.up(fpu, land_avl_conversion);
ov_landexpansion(t, fpu, land_class_agg, "lower")                   = v11_landexpansion.lo(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "lower")                   = v11_landreduction.lo(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "lower")                            = vm_cost_land_transition.lo(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "lower")               = v11_lu_transitions.lo(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "lower")         = v11_landreduction_cost.lo(fpu, land_avl_conversion);
...
oq11_cost_reduction(t, fpu, land_avl_conversion, "lower")           = q11_cost_reduction.lo(fpu, land_avl_conversion);
;
*########### End R section   ###########
