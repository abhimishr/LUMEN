...
SET   iso_all "All countries or regions where IMPACT countries exists as it might have geographic overlap dont do ops on this set"
                /
ABW   "Aruba"
AFG   "Afghanistan"
AGO   "Angola"
...
SHN   "Saint Helena, Ascension, and Tristan de Cunha"
...
SET   iso(iso_all)   "IMPACT Countries"
                /
...
SET  iso2(iso)    "ISO countries dynamic"     ;
SET  fpu2(fpu)    "FPUs dynamic" ;

SET   fpu2iso3(iso, fpu)   "FPU to ISO mapping"
                /
                (AFG) . (AMD_AFG, WAI_AFG)
