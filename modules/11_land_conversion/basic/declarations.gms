...
*** |  authors, and contributors. This file is part of the simple land_class_agg use
...
parameters  
p11_conversion_cost(fpu, land_avl_conversion)       Additional costs for lu transitions (USD per ha)
;
...
q11_cost_reduction(fpu, land_avl_conversion)    Additional costs for lu transitions (000 USD per yr)
;
...
oq11_cost_reduction(t, fpu, land_avl_conversion, type)   Additional costs for lu transitions (000 USD per yr)
;
*########### End R section   ###########
