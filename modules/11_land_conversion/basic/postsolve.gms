...
*########### Begin R section ###########
ov_landexpansion(t, fpu, land_class_agg, "marginal")                = vm_landexpansion.m(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "marginal")                = vm_landreduction.m(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "marginal")                         = vm_cost_land_transition.m(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "marginal")            = vm_lu_transitions.m(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "marginal")      = vm_landreduction_cost.m(fpu, land_avl_conversion);
...
ov_landexpansion(t, fpu, land_class_agg, "level")                   = vm_landexpansion.l(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "level")                   = vm_landreduction.l(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "level")                            = vm_cost_land_transition.l(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "level")               = vm_lu_transitions.l(fpu, land_from,land_to);
ov11_balance_positive(t, fpu, "level")                              = v11_balance_positive.l(fpu);
ov11_balance_negative(t, fpu, "level")                              = v11_balance_negative.l(fpu);
ov_landreduction_cost(t, fpu, land_avl_conversion, "level")         = vm_landreduction_cost.l(fpu, land_avl_conversion);
...
ov_landexpansion(t, fpu, land_class_agg, "upper")                   = vm_landexpansion.up(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "upper")                   = vm_landreduction.up(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "upper")                            = vm_cost_land_transition.up(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "upper")               = vm_lu_transitions.up(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "upper")         = vm_landreduction_cost.up(fpu, land_avl_conversion);
...
ov_landexpansion(t, fpu, land_class_agg, "lower")                   = vm_landexpansion.lo(fpu, land_class_agg);
ov_landreduction(t, fpu, land_class_agg, "lower")                   = vm_landreduction.lo(fpu, land_class_agg);
ov_cost_land_transition(t, fpu, "lower")                            = vm_cost_land_transition.lo(fpu);
ov_lu_transitions(t, fpu, land_from,land_to, "lower")               = vm_lu_transitions.lo(fpu, land_from,land_to);
...
ov_landreduction_cost(t, fpu, land_avl_conversion, "lower")         = vm_landreduction_cost.lo(fpu, land_avl_conversion);
