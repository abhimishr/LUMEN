...
ov_commodity_production(t, fpu, activity_crop, commodity, "marginal")        = vm_commodity_production.m(fpu, activity_crop, commodity);
ov_crop_production_cost(t, fpu, activity_crop, "marginal")                   = vm_crop_production_cost.m(fpu, activity_crop);
ov31_commodity_production_free(t, iso, commodity, "marginal")                = v31_commodity_production_free.m(iso, commodity);
...
ov_commodity_production(t, fpu, activity_crop, commodity, "level")           = vm_commodity_production.l(fpu, activity_crop, commodity);
ov_crop_production_cost(t, fpu, activity_crop, "level")                      = vm_crop_production_cost.l(fpu, activity_crop);
ov31_commodity_production_free(t, iso, commodity, "level")                   = v31_commodity_production_free.l(iso, commodity);
...
ov_commodity_production(t, fpu, activity_crop, commodity, "upper")           = vm_commodity_production.up(fpu, activity_crop, commodity);
ov_crop_production_cost(t, fpu, activity_crop, "upper")                      = vm_crop_production_cost.up(fpu, activity_crop);
ov31_commodity_production_free(t, iso, commodity, "upper")                   = v31_commodity_production_free.up(iso, commodity);
...
ov_commodity_production(t, fpu, activity_crop, commodity, "lower")           = vm_commodity_production.lo(fpu, activity_crop, commodity);
ov_crop_production_cost(t, fpu, activity_crop, "lower")                      = vm_crop_production_cost.lo(fpu, activity_crop);
ov31_commodity_production_free(t, iso, commodity, "lower")                   = v31_commodity_production_free.lo(iso, commodity);
