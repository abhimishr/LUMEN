...
sets
        ...
        iso_all    All countries or regions where IMPACT countries exists as it might have geographic overlap dont do ops on this set
                /
                ABW, AFG, AGO, AIA, ALA, ALB, AND, ARE, ARG, ARM, ASM, ATA, ATF, ATG, AUS, AUT, AZE, 
                BDI, BEL, BEN, BES, BFA, BGD, BGR, BHR, BHS, BIH, BLM, BLR, BLT, BLX, BLZ, BMU, BOL, BRA, BRB, BRN, BTN, BVT, BWA, 
                CAF, CAN, CCK, CHE, CHL, CHM, CHN, CHP, CIV, CMR, COD, COG, COK, COL, COM, CPV, CRB, CRI, CUB, CUW, CXR, CYM, CYP, CZE, 
                DEU, DJI, DMA, DNK, DOM, DZA, 
                ECU, EGY, ERI, ESH, ESP, EST, ETH, 
                FIN, FJI, FLK, FNP, FRA, FRO, FRP, FSM, 
                GAB, GBR, GEO, GGY, GHA, GIB, GIN, GLP, GMB, GNB, GNQ, GRC, GRD, GRL, GSA, GTM, GUF, GUM, GUY, 
                HKG, HMD, HND, HRV, HTI, HUN, 
                IDN, IMN, IND, IOT, IRL, IRN, IRQ, ISL, ISR, ITA, ITP, 
                JAM, JEY, JOR, JPN, KAZ, KEN, KGZ, KHM, KIR, KNA, KOR, KWT, 
                LAO, LBN, LBR, LBY, LCA, LIE, LKA, LSO, LTU, LUX, LVA, 
                MAC, MAF, MAR, MCO, MDA, MDG, MDV, MEX, MHL, MKD, MLI, MLT, MMR, MNE, MNG, MNP, MOR, MOZ, MRT, MSR, MTQ, MUS, MWI, MYS, MYT, 
                NAM, NCL, NER, NFK, NGA, NIC, NIU, NLD, NOR, NPL, NRU, NZL, 
                OAO, OBN, OIO, OMN, OPO, OSA, 
                PAK, PAN, PCN, PER, PHL, PLW, PNG, POL, PRI, PRK, PRT, PRY, PSE, PYF, 
                QAT, 
                RAP, REU, ROU, RUS, RWA, 
                SAU, SDN, SEN, SGP, SGS, SHN, SJM, SLB, SLE, SLV, SMR, SOM, SPM, SPP, SRB, SSD, STP, SUR, SVK, SVN, SWE, SWZ, SXM, SYC, SYR, 
                TCA, TCD, TGO, THA, TJK, TKL, TKM, TLS, TON, TTO, TUN, TUR, TUV, TZA, 
                UGA, UKP, UKR, UMI, URY, USA, UZB, 
