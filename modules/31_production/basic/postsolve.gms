...
*########### Begin R section ###########
ov_crop_production(t, fpu, activity_crop, "marginal")              = v31_crop_production.m(fpu, activity_crop);
...
ov31_production(t, fpu, activity_crop, commodity, "marginal")      = vm_production.m(fpu, activity_crop, commodity);
...
ov_crop_production(t, fpu, activity_crop, "level")                 = v31_crop_production.l(fpu, activity_crop);
...
ov31_production(t, fpu, activity_crop, commodity, "level")         = vm_production.l(fpu, activity_crop, commodity);
...
ov_crop_production(t, fpu, activity_crop, "upper")                 = v31_crop_production.up(fpu, activity_crop);
...
ov31_production(t, fpu, activity_crop, commodity, "upper")         = vm_production.up(fpu, activity_crop, commodity);
...
ov_crop_production(t, fpu, activity_crop, "lower")                 = v31_crop_production.lo(fpu, activity_crop);
...
ov31_production(t, fpu, activity_crop, commodity, "lower")         = vm_production.lo(fpu, activity_crop, commodity);
